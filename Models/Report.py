...
class Report:
    ...
    def load_players(self):
        ...
        (fichier introuvable ou erreur de décodage JSON), un message d'erreur est affiché.
    ...
    def load_tournaments(self):
        """
        Charge la liste des tournois depuis le fichier tournaments.json. En cas d'erreur
        (fichier introuvable ou erreur de décodage JSON), un message d'erreur est affiché.
