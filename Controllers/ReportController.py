...
class ReportController:
    ...
    def tournament_players_alphabetical(self):
        """
        Charge et trie alphabétiquement les joueurs d'un tournoi par nom et prénom.

        Returns:
            list: Joueurs du tournoi triés alphabétiquement.
        """
    ...
    def get_tournament_players_sorted(self, tournament_id):
        """
        Charge et trie la liste des joueurs d'un tournoi par nom et prénom.

        Args:
            tournament_id (int): L'ID du tournoi pour obtenir la liste des joueurs.
